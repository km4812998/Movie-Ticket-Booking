...
function Shows({ openShowsModal, setOpenShowsModal, theatre }) {
    ...
    const columns = [
        ...
        },
        {
            title: 'Date',
            dataIndex: 'date',
            render: (text,record) => moment(text).format('MMMM Do YYYY'),
        },
        {
            title: 'Time',
            dataIndex: 'time',
                ...
                >
                    <Row gutter={[16, 16]}>
                        ...
                        <Col span={8}>
                            ...
                            rules={[{required:true,message:'Please inpout your show date'}]}
                            >
                        ...
                        <Col span={8}>
                            ...
                            rules={[{required:true,message:'Plase input your show time'}]}
                            >
                                <input type='time' />
                            </Form.Item>
                        </Col>
